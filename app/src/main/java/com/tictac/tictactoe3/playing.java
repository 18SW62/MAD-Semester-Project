...
import com.tictac.tictactoe3.Prefences.StoreName;
...
public class playing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new StoreName(this).Save_state(name);


        customView = findViewById(R.id.Canvas);
        ImageView imageView = findViewById(R.id.vloume);
        ORG = new orginizer(this, imageView);
